...
def test_set_location_valid():
    """
    Check that set_location function only sets x and y integer positions. Valid (int) x and y locations.
    """
    ant = a.Ant()
...
def test_set_location_x_invalid():
    """
    Check that set_location functions only sets x and y integer positions. X invalid.
    """
    ant = a.Ant()
...
def test_set_location_y_invalid():
    """
    Check that set_location functions only sets x and y integer positions. Y invalid.
    """
    ant = a.Ant()
